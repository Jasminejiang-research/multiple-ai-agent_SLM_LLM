...
class FinancialAssumptions(BaseModel):
    ...
    runway_months: Annotated[
        ...
        Field(
            ...
            le=120,
            description=(
                "Legacy field: return null. Runway is calculated from financial_model, never guessed."
            ),
        ),
    ]
...
class BusinessProposal(BaseModel):
    product_acceptance: dict = Field(default_factory=dict, description='Program-owned acceptance and residual issues; return empty object.')

...
class ContractContext:
    ...
    def validate(self, candidate, *, version, upstream=(), previous=None, transitive_lineage=False,
                 lineage_identity_continuity=False, dual_declared_lineage=False):
        ...
        verified_upstream = [self.verify_artifact(artifact) for artifact in upstream]
        lineage_claims = [claim for artifact in verified_upstream for claim in claims_in(artifact)]
        for artifact in verified_upstream:
            validate_lineage(artifact, candidate, transitive_lineage=transitive_lineage,
                upstream_claims=lineage_claims, lineage_identity_continuity=lineage_identity_continuity,
                dual_declared_lineage=dual_declared_lineage)
        if previous:
            validate_lineage(self.verify_artifact(previous), candidate, revision=True,
                transitive_lineage=transitive_lineage, upstream_claims=lineage_claims,
                lineage_identity_continuity=lineage_identity_continuity,
                dual_declared_lineage=dual_declared_lineage)

    def accept(self, role, candidate, *, version=1, upstream=(), previous=None,
               pruned=False, unresolved_major=False, transitive_lineage=False,
               lineage_identity_continuity=False, dual_declared_lineage=False):
        ...
        self.validate(candidate, version=version, upstream=upstream, previous=previous,
            transitive_lineage=transitive_lineage, lineage_identity_continuity=lineage_identity_continuity,
            dual_declared_lineage=dual_declared_lineage)
